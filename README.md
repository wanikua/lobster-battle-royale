...
> 我在服务器上养了 10 只 AI 龙虾，让它们互相残杀

10 个不同的 AI Agent（龙虾）被关进同一台服务器，通过 AI 模型自主决策攻击和防御。最后活着的获胜。
...
| 9 | 🔬 NanoClaw | 极简 | 精准打击 | "500 行代码够用了" |
| 10 | 📜 孙子兵法龙虾 | 战略家 | 知彼知己 | "知彼知己，百战不殆" | ← OpenClaw + 孙子兵法 Skill |

## 🧪 实验看点

> **一只读过孙子兵法的龙虾 vs 10 只野生龙虾，兵法到底有没有用？**

11 号龙虾「📜 孙子兵法龙虾」本质上是一只 **OpenClaw 原版龙虾**，但装载了 [孙子兵法 Skill](https://github.com/wanikua/art-of-war)，拥有完整的十三篇战略系统。其他龙虾只有基础性格。这是**故意设计的不公平**——我们要验证的正是：**给 AI 装个孙子兵法 Skill，能不能打赢没有 Skill 的同类？**
...
| 阶段 | 时间 | 伤害倍率 | 规则 |
|------|------|----------|------|
| 🟢 热身赛 | 0-15分钟 | 0.5x | 只扣血不淘汰 |
| 🟡 淘汰赛 | 15-30分钟 | 1.0x | HP≤0 淘汰 |
| 🟠 决赛圈 | 30-40分钟 | 2.0x | 伤害翻倍 |
| 🔴 最终对决 | 40-60分钟 | 3.0x | 最后的决战 |
